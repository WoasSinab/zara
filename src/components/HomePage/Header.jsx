function Header() {
  return (
    <header>
      <div className=' content-center p-10 container mx-auto flex justify-between items-center h-16 border-b-2 border-gray-200 '>
        <div className='w-8'>
          <svg className='text-gray-700' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16'>
            <path
              fill='none'
              stroke='currentColor'
