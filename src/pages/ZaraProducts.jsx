    ...
    <div>
      ...
      <div className=" flex flex-row justify-between  my-12">
        ...
        <div className="flex justify-center ">
          <h1 className="relative z-10">THE NEW STUFF</h1>
          <p className="absolute mt-[-1%] z-0 text-orange-800 opacity-20 text-3xl md:text-5xl lg:text-5xl font-bold"  style={{ fontFamily: '"Playfair Display", serif', }}>2223</p>
        </div>
        <div>
