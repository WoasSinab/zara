...
import ZaraProTopSeller from "../components/ZaraProducts/ZaraProTopSeller";
import Footer from "../components/HomePage/Footer"
import ZaraProBanner from "../components/ZaraProducts/ZaraProBanner";
    ...
    <div className="mx-40 flex flex-col">
        <div className=' flex flex-row justify-between  my-12 mx-8'>
          ...
          <div className='flex justify-center'>
            ...
            <p
              className='hidden lg:block absolute mt-[-1%] z-0 text-orange-800 opacity-20 text-3xl md:text-5xl lg:text-5xl font-bold'
        ...
        <section className='w-full py-16 '>
          <div
            style={{ fontFamily: '"Playfair Display", serif' }}
            className='mx-4 relative pb-12 font-bold flex flex-row text-3xl items-center'
          >
